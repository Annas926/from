...
<form class="form-horizontal" nama="f1" method="POST" action="tbl.php">
<fieldset>
...
<div class="form-group">
      ...
      <div class="col-md-4">
      <input id="Nama Lengkap" name="Nama Lengkap" type="text" placeholder="Monggo" class="form-control input-md">
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="Umur" name="Umur" type="text" placeholder="Monggo" class="form-control input-md">
